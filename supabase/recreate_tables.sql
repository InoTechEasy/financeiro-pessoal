-- Script para recriar todas as tabelas com IDs numéricos auto increment
...
-- Tabela de Tipos de Lançamentos (Dados de dimensão - compartilhados)
...
-- Tabela de Tipos de Pagamentos (Dados de dimensão - compartilhados)
...
-- Tabela de Categorias de Despesas (Dados de dimensão - compartilhados)
...
-- Tabela de Receitas (Dados de dimensão - compartilhados)
...
-- Tabela de Investimentos (Dados de dimensão - compartilhados)
...
-- Políticas RLS para tabelas de dimensão (acesso público para leitura)
CREATE POLICY "Public read access for dimension tables" ON d_tipos_lancamentos
  FOR SELECT USING (true);

CREATE POLICY "Public read access for dimension tables" ON d_tipos_pagamentos
  FOR SELECT USING (true);

CREATE POLICY "Public read access for dimension tables" ON d_categorias_despesas
  FOR SELECT USING (true);

CREATE POLICY "Public read access for dimension tables" ON d_receitas
  FOR SELECT USING (true);

CREATE POLICY "Public read access for dimension tables" ON d_investimentos
  FOR SELECT USING (true);
