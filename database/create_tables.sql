...
-- ============================================
-- TABELA FATO CONCILIAÇÃO BANCÁRIA
-- ============================================

CREATE TABLE public.f_conciliacao_bancaria (
  id_conciliacao UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  id_banco UUID NOT NULL REFERENCES public.d_bancos(id_banco),
  data_inicio DATE NOT NULL,
  data_fim DATE NOT NULL,
  saldo_inicial NUMERIC(15,2) DEFAULT 0,
  saldo_final NUMERIC(15,2) DEFAULT 0,
  saldo_bancario_final NUMERIC(15,2) DEFAULT 0,
  diferenca_saldo NUMERIC(15,2) DEFAULT 0,
  status_conciliacao VARCHAR(20) DEFAULT 'PENDENTE' CHECK (status_conciliacao IN ('PENDENTE', 'CONCILIADO', 'DIVERGENCIA')),
  observacoes TEXT,
  created_at TIMESTAMP DEFAULT NOW(),
  updated_at TIMESTAMP DEFAULT NOW()
);
...
CREATE INDEX idx_f_conciliacao_bancaria_banco ON public.f_conciliacao_bancaria(id_banco);
CREATE INDEX idx_f_conciliacao_bancaria_periodo ON public.f_conciliacao_bancaria(data_inicio, data_fim);
